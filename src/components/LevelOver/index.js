  ...
  (
    ...
    const showModal = (heroId) => {
      ...
      if(storageItem && storageItem.id === heroId) {
        ...
        axios.get(`https://gateway.marvel.com/v1/public/characters/${heroId}?ts=1&apikey=${API_PUBLIC_KEY}&hash=${API_HASH}`)
          .then((response) => {
            localStorage.setItem("marvelCharacter", JSON.stringify(response.data.data.results[0]));
    ...
    const dataDisplay =
      score >= averageGrade ? (
        ...
        <tr>
          <td colSpan="3">
            <Loader styling={{ textAlign: "center", color: "red" }} text="Pas de réponses!" />
          </td>
        </tr>
      );
    ...
    const messageDisplay =
      score >= averageGrade ? (
        ...
        <>
          ...
          <button className="btnResult success">Restart</button>
        </>
      );
      ...
      <div className="modalHeader">
          ...
          <div className="modalBody">
            <div className="comicImage">
              <img src={characterData.data.results[0].thumbnail.path+"."+characterData.data.results[0].thumbnail.extension} alt={characterData.data.results[0].name} />
    ...
    (
      ...
      <div className="modalHeader">
          ...
          <div className="modalBody">
            <Loader styling={{ textAlign: "center", color: "red" }} text="Chargement..." />
          </div>
          <div className="modalFooter">
